 ...
 *
 * Код намеренно развёрнут (циклы с фигурными скобками, без компактного синтаксиса),
 * чтобы переживать минификатор Tilda.
 */
(function () {
    ...
    // В Tilda Zero блоки иногда вставляются позже — подстраховка повторными проходами.
    setTimeout(initAll, 500);
    setTimeout(initAll, 1500);

    // экспортируем на случай динамической вставки абакусов после загрузки
